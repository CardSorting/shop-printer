...
export const LIFECYCLE_PLAYBOOKS: LifecyclePlaybook[] = [
    ...
    steps: [
      {
        ...
        bodyTemplate: '<p>If everything arrived as expected, your review helps other guests choose with confidence. If not, reply here and we will help first.</p>',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    audience: 'Top spenders, regulars, and repeat customers showing signs of cooling.',
    offerStrategy: 'vip_access',
    priority: 10,
    frequencyCapDays: 21,
    conversionWindowDays: 21,
    ...
    steps: [
      {
        ...
        bodyTemplate: '<p>You have been one of our most loyal regulars. We set aside a few recommendations before they hit the broader list.</p>',
      },
    ],
  },
  {
