...
export const LANDING_COPY = {
  ...
  vendors: {
    ...
    social: {
      ...
      closedHint: 'Counters prepped · walk in when doors open',
      countdownOpens: 'Opens in',
      countdownCloses: 'Closes in',
      countdownSlot: 'Next slot',
      metrics: {
        guests: 'On the floor',
      ...
      signals: ['Walk-in anytime', 'Mix 9 kitchens', 'Shared tables'],
    },
    floorBanner: {
      secondary: { label: 'Hours & directions', href: '#landing-visit' },
    },
