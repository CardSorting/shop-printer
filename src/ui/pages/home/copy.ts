...
export const LANDING_COPY = {
  ...
  vendors: {
    ...
    social: {
      ...
      busyFiring: 'firing',
      waitSuffix: 'm wait',
      crowdLine: 'Regulars mixing menus · shared tables filling up',
      walkInLine: 'Walk in · no reservation · mix any counter at one table',
      cravingEyebrow: 'On the pass right now',
      closedCountdown: 'Opens soon',
      closedHint: 'Counters prepped · pastry warming · walk in when doors open',
      countdownOpens: 'Doors open in',
      countdownCloses: 'Rush ends in',
      countdownSlot: 'Next pickup slot',
      metrics: {
        guests: 'On the floor',
        ordersHour: 'Orders · last hour',
        tables: 'Tables taken',
        pickupQueue: 'Pickup queue',
        viewing: 'Ordering now',
        lastOrder: 'Last order',
        pickupWait: 'Est. pickup',
      },
      signals: ['Walk-in anytime', 'Mix 9 kitchens', 'Shared tables', 'Order ahead · skip the wait'],
    },
    floorBanner: {
      headline: 'Don’t scroll hungry.',
      sub: 'The hall is open — pull up a chair before the good tables go.',
      ctaNote: 'Order ahead · pick up at any counter · no app required',
      activityLabel: 'Live floor feed',
      secondary: { label: 'Hours & directions', href: '#landing-visit' },
    },
    tiles: [
