...
Enforced by `src/tests/protocol-guard.test.ts` (included in `npm run test:storefront-release`). Storefront lane map: [storefront-release.md](./storefront-release.md).
